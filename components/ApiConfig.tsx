...
export function ApiConfig({ isOpen, onClose }: ApiConfigProps) {
    ...
    return (
        <div
            ...
            data-oid="dhk8omp"
        >
            <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4" data-oid="_j-007i">
                <h3 className="text-lg font-semibold mb-4" data-oid="8_tdq9:">
                    API Configuration
                </h3>

                <div className="space-y-4" data-oid="1ur4bz:">
                    <div data-oid="53anvog">
                        <label
                    ...
                    <div className="flex items-center space-x-2" data-oid="vn8jv0r">
                        <button
                ...
                <div className="flex justify-end space-x-3 mt-6" data-oid="n1eb6:a">
                    <button
                        onClick={onClose}
