    ...
    return (
        ...
        >
            <div
                ...
                data-oid="f.p9vhl"
            >
                <div className="flex justify-between items-center mb-6" data-oid="k-qonl7">
                    <h2 className="text-xl font-semibold" data-oid="5fudk98">
                        Database Servers
                    </h2>
                    <button
                ...
                {!showAddForm && !editingServer && (
                    <>
                        <div className="flex justify-between items-center mb-4" data-oid="uad14rh">
                            <p className="text-gray-600" data-oid="l86h.8z">
                            ...
                            >
                                ...
                                <span data-oid="nkm-nkz">Add Server</span>
                            </button>
                        </div>

                        <div className="space-y-4" data-oid="cn609lc">
                            {servers.map((server) => (
                                <div
                                    key={server.id}
                                ...
                                >
                                    ...
                                    >
                                        <div
                                            ...
                                            data-oid="_m9umj6"
                                        >
                                            <span className="text-2xl" data-oid="flb.g83">
                                                {getServerTypeIcon(server.type)}
                                            </span>
                                            <div data-oid="m7szvaq">
                                                <h3
...
function ServerForm({ server, onSave, onCancel }: ServerFormProps) {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4" data-oid="..hx4xb">
            <h3 className="text-lg font-medium" data-oid="hdvy:v7">
                {server?.id ? 'Edit Server' : 'Add New Server'}
            </h3>

            <div className="grid grid-cols-2 gap-4" data-oid="gmobk1e">
                <div data-oid="jyvx6yr">
                    <label
                ...
                <div data-oid="oy99e2t">
                    ...
                    <select
                        ...
                        data-oid="qspgb:9"
                    >
                        <option value="qdrant" data-oid="4ezc_k_">
                            Qdrant
                        </option>
                        <option value="neo4j" data-oid="u.m:_3u">
                            Neo4j
                        </option>
                        <option value="pinecone" data-oid="ly3umul">
                            Pinecone
                        </option>
                        <option value="weaviate" data-oid="r3-sv-e">
                            Weaviate
                        </option>
                        <option value="chroma" data-oid="hdf0d:o">
                            Chroma
                        </option>
                    </select>
                </div>
                ...
                {formData.type === 'pinecone' && (
                    <div className="col-span-2" data-oid="fdz1_r8">
                        <label
                            className="block text-sm font-medium text-gray-700 mb-1"
                            data-oid="l6vpnxu"
                        >
            ...
            <div className="flex justify-end space-x-3 pt-4" data-oid="4e78f4m">
                <button
                    type="button"
                    onClick={onCancel}
