    ...
    return (
        ...
        >
            <div
                ...
                data-oid="j.y.78f"
            >
                <div className="flex justify-between items-center mb-6" data-oid=":_qa8_7">
                    <h2 className="text-xl font-semibold" data-oid="j90d43f">
                        Database Servers
                    </h2>
                    <button
                ...
                {!showAddForm && !editingServer && (
                    <>
                        <div className="flex justify-between items-center mb-4" data-oid="cste6hw">
                            <p className="text-gray-600" data-oid="jitea36">
                            ...
                            >
                                ...
                                <span data-oid="gvyt97p">Add Server</span>
                            </button>
                        </div>

                        <div className="space-y-4" data-oid="72bvwli">
                            {servers.map((server) => (
                                <div
                                    key={server.id}
                                ...
                                >
                                    ...
                                    >
                                        <div
                                            ...
                                            data-oid="hz6mdxn"
                                        >
                                            <span className="text-2xl" data-oid="tq_8ixb">
                                                {getServerTypeIcon(server.type)}
                                            </span>
                                            <div data-oid="7ikv2m7">
                                                <h3
...
function ServerForm({ server, onSave, onCancel }: ServerFormProps) {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4" data-oid="iff6mdh">
            <h3 className="text-lg font-medium" data-oid="7wvvn7y">
                {server?.id ? 'Edit Server' : 'Add New Server'}
            </h3>

            <div className="grid grid-cols-2 gap-4" data-oid="mi38ems">
                <div data-oid="hd9u2qw">
                    <label
                ...
                <div data-oid="vp38u2s">
                    ...
                    <select
                        ...
                        data-oid="jmwxbc-"
                    >
                        <option value="qdrant" data-oid="w7hnvq:">
                            Qdrant
                        </option>
                        <option value="neo4j" data-oid="9r:lkq:">
                            Neo4j
                        </option>
                        <option value="pinecone" data-oid="p7nsls0">
                            Pinecone
                        </option>
                        <option value="weaviate" data-oid="snw2czh">
                            Weaviate
                        </option>
                        <option value="chroma" data-oid="va1n8q4">
                            Chroma
                        </option>
                    </select>
                </div>

                <div data-oid="bs.9icg">
                    <label
                        className="block text-sm font-medium text-gray-700 mb-1"
                        data-oid="sydc9e:"
                    >
                ...
                {formData.type === 'pinecone' && (
                    <div className="col-span-2" data-oid="tj:ltb:">
                        <label
                            className="block text-sm font-medium text-gray-700 mb-1"
                            data-oid=":4lfjba"
                        >
            ...
            <div className="flex justify-end space-x-3 pt-4" data-oid="mdm6ipe">
                <button
                    type="button"
                    onClick={onCancel}
