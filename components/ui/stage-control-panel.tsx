  ...
  return (
    <div className={`space-y-4 ${className}`}>
      ...
      <div className="bg-white rounded-lg border p-6">
        ...
        <div className="flex items-stretch space-x-4 overflow-x-auto pb-4">
                ...
                {shouldCollapse ? (
                  <div className="flex flex-col items-center p-3 bg-gray-50 rounded-lg border border-gray-200 w-[20px] h-full justify-start space-y-3">
                    ...
                    <div className="flex-1 flex items-center justify-center">
                      <span className={`text-xs font-medium whitespace-nowrap transform rotate-90 ${
                  ...
                  <div className={`
                    relative flex flex-col items-center p-4 rounded-lg border-2 transition-all duration-200 min-w-[200px]
                  ...
                  `}>
                    ...
                    {!stageInfo?.startedAt && (
                      <p className="text-xs text-gray-500 mb-2">Est: {stageConfig.estimatedTime}</p>
                    )}
